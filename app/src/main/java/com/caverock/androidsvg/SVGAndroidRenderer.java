...
public class SVGAndroidRenderer
{
   ...
   private void  render(SvgObject obj)
   {
      ...
      } else if (obj instanceof SVG.Glyph) {
         String raw = ((Glyph) obj).glyphUnicode;
         Spanned s = Html.fromHtml(Html.fromHtml((String) raw).toString());
         render((SVG.Glyph) obj);
   ...
   private void render(SvgRect obj)
   {
      debug("Rect render");
   ...
   private void addObjectToClip(SVG.GraphicsElement obj, Path combinedPath, Matrix combinedPathMatrix)
   {
      ...
      if (obj instanceof SvgRect)
         path = makePathAndBoundingBox((SvgRect) obj);
      else if (obj instanceof SVG.Circle)
   ...
   private Path makePathAndBoundingBox(SvgRect obj)
   {
      float x, y, w, h, rx, ry;
